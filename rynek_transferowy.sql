...
--
-- Host: 127.0.0.1
-- Czas generowania: 09 Lut 2018, 16:32
...
CREATE TABLE `pilkarze` (
  ...
  `imie_pilkarza` varchar(30) NOT NULL,
  `nazwisko_pilkarza` varchar(30) NOT NULL,
...
(43, 'Sergio', 'Aguero', 65000000, 10, 11, 18),
...
(211, 'Jacek', 'Bieganowski', 32000000, 1, 224, 2);
...
(3, 35000000, '2018-01-16', 7, 17, 146),
(7, 46000000, '2018-01-05', 13, 18, 163),
(8, 18000000, '2018-01-06', 7, 18, 52),
(9, 39000000, '2018-01-04', 21, 14, 184),
...
CREATE TABLE `trenerzy` (
  ...
  `imie_trenera` varchar(30) NOT NULL,
  `nazwisko_trenera` varchar(30) NOT NULL,
  `ID_kraj_FK` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
ALTER TABLE `kluby`
  MODIFY `ID_klub_PK` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `ligi`
  MODIFY `ID_liga_PK` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `transfery`
  MODIFY `ID_transfer_PK` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;

--
-- AUTO_INCREMENT dla tabeli `trenerzy`
--
ALTER TABLE `trenerzy`
  MODIFY `ID_trener_PK` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
...
ALTER TABLE `kluby`
  ...
  ADD CONSTRAINT `kluby_ibfk_2` FOREIGN KEY (`ID_stadion_FK`) REFERENCES `stadiony` (`ID_stadion_PK`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `kluby_ibfk_3` FOREIGN KEY (`ID_trener_FK`) REFERENCES `trenerzy` (`ID_trener_PK`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `kluby_ibfk_4` FOREIGN KEY (`ID_liga_FK`) REFERENCES `ligi` (`ID_liga_PK`) ON DELETE NO ACTION ON UPDATE NO ACTION;
