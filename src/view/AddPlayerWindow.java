...
public class AddPlayerWindow extends JFrame {
	...
	public AddPlayerWindow(Connector connector, JFrame window) {
		setIconImage(Toolkit.getDefaultToolkit().getImage(AddPlayerWindow.class.getResource("/resources/001-add.png")));
	...
	private void addEvents() {
		...
		btnDodaj.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String wartosc = textFieldWartosc.getText();
				...
				connector.addPlayer(imie, nazwisko, wartosc, pozycja, kraj, klub);
				BasicWindow.statusLabel.setText("Dodano pi³karza " + imie + " " + nazwisko);
				BasicWindow.table.setModel(connector.getModelOfPlayers());
				BasicWindow.table.setRowSorter(new TableRowSorter<DefaultTableModel>(connector.getModelOfPlayers()));
